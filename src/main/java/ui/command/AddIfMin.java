...
public class AddIfMin extends NonTerminatingCommand {
    MusicBandRepo musicBandRepo;

    public AddIfMin(UserInterface userInterface, MusicBandRepo musicBandRepo) {
        super(userInterface);
    ...
    public void run() {
        ...
        MusicBand musicBand = MusicBand.builder()
                ...
                .bestAlbum(album)
                .build();
        musicBandRepo.addIfMin(musicBand);
    }
}
